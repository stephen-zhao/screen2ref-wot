  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "PageOptions_LabelDiv" },
          React.createElement(
            "span",
            null,
            "Reload"
      ...
      React.createElement(
        ...
        React.createElement(
          "label",
          { className: "PageOptions_LabelModifier" },
          React.createElement("input", { id: "cb_has_bia", type: "checkbox", ref: "cb_has_bia", className: "PageOptions_cbOption",
            value: "1", checked: this.props.options.hasBia, onChange: this.handleChange }),
          React.createElement(
            "div",
            { className: "PageOptions_LabelDiv PageOptions_LabelDivCB" },
            React.createElement(
              "span",
              null,
              "BIA"
      ...
      React.createElement(
        ...
        React.createElement(
          "label",
          { className: "PageOptions_LabelModifier" },
          React.createElement("input", { id: "cb_has_rammer", type: "checkbox", ref: "cb_has_rammer", className: "PageOptions_cbOption",
      ...
      React.createElement(
        ...
        React.createElement(
          "label",
          { className: "PageOptions_LabelModifier" },
          React.createElement("input", { id: "cb_has_vents", type: "checkbox", ref: "cb_has_vents", className: "PageOptions_cbOption",
...
var TableOfTanksColumnClass = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(ListOfTanksWAttributes, { nation: this.props.nation, tankClass: this.props.tankClass,
